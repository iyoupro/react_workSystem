      ...
      {type !== 'SectionTitle' && mode === 'edit' &&
        <div className={styles.footer}>
          ...
          {calcScore !== false && isSelected && (type === 'Radio' || type === 'Checkbox') && 
            <Switch className={styles.footerItem} checkedChildren="是" unCheckedChildren="否" checked={calcScore === 'auto'} onChange={value => setData('calcScore', value ? 'auto' : true)}/>
          }
          计分：{isSelected &&
            <Switch className={styles.footerItem} checkedChildren="是" unCheckedChildren="否" checked={calcScore !== false} onChange={value => setData('calcScore', value)}/>
          }
          ...
          必填：{isSelected &&
            <Switch className={styles.footerItem} checkedChildren="是" unCheckedChildren="否" checked={isRequired} onChange={value => setData('isRequired', value)}/>
          }
          显示说明：{isSelected &&
          <Switch className={styles.footerItem} checkedChildren="是" unCheckedChildren="否" checked={typeof description === 'string' ? true : false} onChange={value => setData('description', value ? '' : null)}/>
          }
          显示评论：{isSelected &&
          <Switch className={styles.footerItem} checkedChildren="是" unCheckedChildren="否" checked={typeof comment === 'string' ? true : false} onChange={value => setData('comment', value ? '' : null)}/>
          }
        </div>
      }
    </li>
